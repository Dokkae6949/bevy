...
/// <div style="background-color: #E13535; width: 10px; padding: 10px; border: 1px solid;"></div> - error
pub const ERROR: Color = Color::oklcha(0.505, 0.2, 27.0, 1.0);
/// <div style="background-color: #F5C51D; width: 10px; padding: 10px; border: 1px solid;"></div> - warning
pub const WARNING: Color = Color::oklcha(0.855, 0.18, 100.0, 1.0);
/// <div style="background-color: #42B883; width: 10px; padding: 10px; border: 1px solid;"></div> - success
pub const SUCCESS: Color = Color::oklcha(0.705, 0.13, 150.0, 1.0);
/// <div style="background-color: #3498DB; width: 10px; padding: 10px; border: 1px solid;"></div> - info
pub const INFO: Color = Color::oklcha(0.7, 0.17, 230.0, 1.0);
